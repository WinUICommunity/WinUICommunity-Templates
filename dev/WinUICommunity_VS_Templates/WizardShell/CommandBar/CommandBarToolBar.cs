...
namespace iNKORE.UI.WPF.Modern
{
    ...
    public class CommandBarToolBar : ToolBar
    {
        ...
        {
            m_moreButtonClosedToolTip = new ToolTip { Content = "See more" };
            m_moreButtonOpenToolTip = new ToolTip { Content = "See less" };
        }
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (m_moreButton != null)
            {
                AutomationProperties.SetName(m_moreButton, "More app bar");
